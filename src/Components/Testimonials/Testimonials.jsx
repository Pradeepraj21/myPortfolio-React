  ...
  const clients = [
    {
      ...
      img: mca_3,
      review:
        "Café Management System is a Web Application that has been created to provide a solution for a café/food-chain restaurant which operates like McDonald’s and it will enable the person on the counter (server) to accept orders from customer and pass it to the chef so that the chef can prepare the food/beverage, post that the admin can view entire order history and can also search/filter through them.",
    },
    {
